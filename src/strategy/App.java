...
import strategy.IGR.Algerie;
import strategy.IGR.Maroc;
import strategy.IGR.Pays;

public class App {
    public static void main(String[] args) {

        Employee e1 = new Employee("1", 1100);
        e1.setPays(new Algerie());
        ...
        Employee e2 = new Employee("2", 11000);
        e2.setPays(new Maroc());
        System.out.println("Employé au Maroc :");
        System.out.println(" Salaire Brut mensuel :"+e2.getSalaireBrutMensuel());
